...
INSTANCE 		WYJEBANE_W_REPUTACJE (C_SFX_DEF)		
{
	file="WYJEBANE_W_REPUTACJE.wav";		   		
	vol=100;				    		
};

INSTANCE 		GONG (C_SFX_DEF)		
{
	file="GONG.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT1 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT1.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT2 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT2.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT3 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT3.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT4 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT4.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT5 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT5.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT6 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT6.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT7 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT7.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT8 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT8.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT9 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT9.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT10 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT10.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT11 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT11.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT12 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT12.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT13 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT13.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT14 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT14.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT15 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT15.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT16 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT16.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT17 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT17.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT18 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT18.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT19 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT19.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT20 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT20.wav";		   		
	vol=100;				    		
};


INSTANCE 		LUTNIA_INSERT21 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT21.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT22 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT22.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT23 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT23.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT24 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT24.wav";		   		
	vol=100;				    		
};

INSTANCE 		LUTNIA_INSERT25 (C_SFX_DEF)		
{
	file="LUTNIA_INSERT25.wav";		   		
	vol=100;				    		
};

INSTANCE 		TRUMPET (C_SFX_DEF)		
{
	file="TRUMPET.wav";		   		
	vol=100;				    		
};

INSTANCE 		HORNLAND (C_SFX_DEF)		
{
	file="HORNLAND.wav";		   		
	vol=100;				    		
};

INSTANCE 		UCZACZA (C_SFX_DEF)		
{
	file="UCZACZA.wav";		   		
	vol=100;				    		
};

INSTANCE 		KRZYK_ORK (C_SFX_DEF)		
{
	file="KRZYK_ORK.wav";		   		
	vol=100;				    		
};

INSTANCE 		PUMPED (C_SFX_DEF)		
{
	file="PUMPED.wav";		   		
	vol=100;				    		
};

INSTANCE 		RICK (C_SFX_DEF)		
{
	file="RICK.wav";		   		
	vol=100;				    		
};

INSTANCE 		GELDERN (C_SFX_DEF)		
{
	file="GELDERN.wav";		   		
	vol=100;				    		
};

INSTANCE 		KINGDOM1 (C_SFX_DEF)		
{
	file="KINGDOM1.wav";		   		
	vol=100;				    		
};

INSTANCE 		KINGDOM2 (C_SFX_DEF)		
{
	file="KINGDOM2.wav";		   		
	vol=100;				    		
};

INSTANCE 		DENIS (C_SFX_DEF)		
{
	file="DENIS.wav";		   		
	vol=100;				    		
};

INSTANCE 		COFFIN (C_SFX_DEF)		
{
	file="COFFIN.wav";		   		
	vol=100;				    		
};

INSTANCE 		BATTLETHEME (C_SFX_DEF)		
{
	file="BATTLETHEME.wav";		   		
	vol=100;				    		
};

INSTANCE 		BGEXPLORE (C_SFX_DEF)		
{
	file="BGEXPLORE.wav";		   		
	vol=100;				    		
};

INSTANCE 		BGGORION (C_SFX_DEF)		
{
	file="BGGORION.wav";		   		
	vol=100;				    		
};

INSTANCE 		BGHELMTEMPLE (C_SFX_DEF)		
{
	file="BGHELMTEMPLE.wav";		   		
	vol=100;				    		
};

INSTANCE 		BGTAVERN (C_SFX_DEF)		
{
	file="BGTAVERN.wav";		   		
	vol=100;				    		
};

INSTANCE 		TAVERN1 (C_SFX_DEF)		
{
	file="TAVERN1.wav";		   		
	vol=100;				    		
};

INSTANCE 		TAVERN2 (C_SFX_DEF)		
{
	file="TAVERN2.wav";		   		
	vol=100;				    		
};

INSTANCE 		BLOODLINE (C_SFX_DEF)		
{
	file="BLOODLINE.wav";		   		
	vol=100;				    		
};

INSTANCE 		CELTIC1 (C_SFX_DEF)		
{
	file="CELTIC1.wav";		   		
	vol=100;				    		
};

INSTANCE 		CELTIC2 (C_SFX_DEF)		
{
	file="CELTIC2.wav";		   		
	vol=100;				    		
};

INSTANCE 		DARKSLAVIC (C_SFX_DEF)		
{
	file="DARKSLAVIC.wav";		   		
	vol=100;				    		
};

INSTANCE 		FABLES (C_SFX_DEF)		
{
	file="FABLES.wav";		   		
	vol=100;				    		
};

INSTANCE 		FACELESS (C_SFX_DEF)		
{
	file="FACELESS.wav";		   		
	vol=100;				    		
};

INSTANCE 		GANGSTA (C_SFX_DEF)		
{
	file="GANGSTA.wav";		   		
	vol=100;				    		
};

INSTANCE 		HOUSEBUILDING (C_SFX_DEF)		
{
	file="HOUSEBUILDING.wav";		   		
	vol=100;				    		
};

INSTANCE 		KICKSTART (C_SFX_DEF)		
{
	file="KICKSTART.wav";		   		
	vol=100;				    		
};

INSTANCE 		MEDIEVAL1 (C_SFX_DEF)		
{
	file="MEDIEVAL1.wav";		   		
	vol=100;				    		
};

INSTANCE 		MEDIEVAL2 (C_SFX_DEF)		
{
	file="MEDIEVAL2.wav";		   		
	vol=100;				    		
};

INSTANCE 		MEDIEVAL3 (C_SFX_DEF)		
{
	file="MEDIEVAL3.wav";		   		
	vol=100;				    		
};

INSTANCE 		MEDIEVAL4 (C_SFX_DEF)		
{
	file="MEDIEVAL4.wav";		   		
	vol=100;				    		
};

INSTANCE 		MINERALFIUTA (C_SFX_DEF)		
{
	file="MINERALFIUTA.wav";		   		
	vol=100;				    		
};

INSTANCE 		MJOLNIR (C_SFX_DEF)		
{
	file="MJOLNIR.wav";		   		
	vol=100;				    		
};

INSTANCE 		SLAVIC (C_SFX_DEF)		
{
	file="SLAVIC.wav";		   		
	vol=100;				    		
};

INSTANCE 		SVETOVID (C_SFX_DEF)		
{
	file="SVETOVID.wav";		   		
	vol=100;				    		
};

INSTANCE 		TEMPLARS (C_SFX_DEF)		
{
	file="TEMPLARS.wav";		   		
	vol=100;				    		
};

INSTANCE 		UNFORGIVEN (C_SFX_DEF)		
{
	file="UNFORGIVEN.wav";		   		
	vol=100;				    		
};

INSTANCE 		VIKING (C_SFX_DEF)		
{
	file="VIKING.wav";		   		
	vol=100;				    		
};

INSTANCE 		WEREWOLFES (C_SFX_DEF)		
{
	file="WEREWOLFES.wav";		   		
	vol=100;				    		
};

INSTANCE 		BRAWL (C_SFX_DEF)		
{
	file="BRAWL.wav";		   		
	vol=100;				    		
};

INSTANCE 		BATTLEARENA (C_SFX_DEF)		
{
	file="BATTLEARENA.wav";		   		
	vol=100;				    		
};

INSTANCE 		BEASTHUNT (C_SFX_DEF)		
{
	file="BEASTHUNT.wav";		   		
	vol=100;				    		
};

INSTANCE 		SKULL (C_SFX_DEF)		
{
	file="SKULL.wav";		   		
	vol=100;				    		
};

INSTANCE 		FOCUS (C_SFX_DEF)		
{
	file="FOCUS.wav";		   		
	vol=100;				    		
};

INSTANCE 		FREEMINE (C_SFX_DEF)		
{
	file="FREEMINE.wav";		   		
	vol=100;				    		
};

INSTANCE 		MINE (C_SFX_DEF)		
{
	file="MINE.wav";		   		
	vol=100;				    		
};

INSTANCE 		HERRMANNELIG (C_SFX_DEF)		
{
	file="HERRMANNELIG.wav";		   		
	vol=100;				    		
};

INSTANCE 		QUEEN (C_SFX_DEF)		
{
	file="QUEEN.wav";		   		
	vol=100;				    		
};

INSTANCE 		MINECRAWLERS (C_SFX_DEF)		
{
	file="MINECRAWLERS.wav";		   		
	vol=100;				    		
};

INSTANCE 		VALLEYNIGHT (C_SFX_DEF)		
{
	file="VALLEYNIGHT.wav";		   		
	vol=100;				    		
};

INSTANCE 		VALLEY (C_SFX_DEF)		
{
	file="VALLEY.wav";		   		
	vol=100;				    		
};

INSTANCE 		VALLEY2 (C_SFX_DEF)		
{
	file="VALLEY2.wav";		   		
	vol=100;				    		
};

INSTANCE 		VALLEY3 (C_SFX_DEF)		
{
	file="VALLEY3.wav";		   		
	vol=100;				    		
};

INSTANCE 		SWAMP (C_SFX_DEF)		
{
	file="SWAMP.wav";		   		
	vol=100;				    		
};

INSTANCE 		NEWCAMP (C_SFX_DEF)		
{
	file="NEWCAMP.wav";		   		
	vol=100;				    		
};

INSTANCE 		NIGHTWATCH (C_SFX_DEF)		
{
	file="NIGHTWATCH.wav";		   		
	vol=100;				    		
};

INSTANCE 		OLDCAMP (C_SFX_DEF)		
{
	file="OLDCAMP.wav";		   		
	vol=100;				    		
};

INSTANCE 		OLDMINE (C_SFX_DEF)		
{
	file="OLDMINE.wav";		   		
	vol=100;				    		
};

INSTANCE 		ORCCAMP (C_SFX_DEF)		
{
	file="ORCCAMP.wav";		   		
	vol=100;				    		
};

INSTANCE 		ORCTEMMPLE (C_SFX_DEF)		
{
	file="ORCTEMMPLE.wav";		   		
	vol=100;				    		
};

INSTANCE 		OREHEAP (C_SFX_DEF)		
{
	file="OREHEAP.wav";		   		
	vol=100;				    		
};

INSTANCE 		AWAKENING (C_SFX_DEF)		
{
	file="AWAKENING.wav";		   		
	vol=100;				    		
};

INSTANCE 		SWAMPNIGHT (C_SFX_DEF)		
{
	file="SWAMPNIGHT.wav";		   		
	vol=100;				    		
};

INSTANCE 		SWAMPCAMP (C_SFX_DEF)		
{
	file="SWAMPCAMP.wav";		   		
	vol=100;				    		
};

INSTANCE 		SWAMPTEMPLE (C_SFX_DEF)		
{
	file="SWAMPTEMPLE.wav";		   		
	vol=100;				    		
};

INSTANCE 		SWAMPSHARK (C_SFX_DEF)		
{
	file="SWAMPSHARK.wav";		   		
	vol=100;				    		
};

INSTANCE 		HORDES (C_SFX_DEF)		
{
	file="HORDES.wav";		   		
	vol=100;				    		
};

INSTANCE 		EXODUS (C_SFX_DEF)		
{
	file="EXODUS.wav";		   		
	vol=100;				    		
};
...
instance sheep_AMBIENT(C_SFX_DEF)
{
	file = "SHP_Ambient_01.wav";
	vol = 40;
};

instance sheep_AMBIENT_A1(C_SFX_DEF)
{
	file = "SHP_Ambient_02.wav";
	vol = 30;
};

instance sheep_AMBIENT_A2(C_SFX_DEF)
{
	file = "SHP_Ambient_03.wav";
	vol = 20;
};

instance sheep_AMBIENT_A3(C_SFX_DEF)
{
	file = "SHP_Ambient_04.wav";
	vol = 30;
};

instance sheep_AMBIENT_A4(C_SFX_DEF)
{
	file = "SHP_Ambient_05.wav";
	vol = 40;
};

instance sheep_AMBIENT_A5(C_SFX_DEF)
{
	file = "SHP_Ambient_06.wav";
	vol = 50;
};

instance sheep_AMBIENT_A6(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_AMBIENT_A7(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_AMBIENT_A8(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_AMBIENT_A9(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_AMBIENT_A10(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_AMBIENT_A11(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_AMBIENT_A12(C_SFX_DEF)
{
	file = "nosound.wav";
	vol = 0;
};

instance sheep_EAT(C_SFX_DEF)
{
	file = "SHP_Eat_01.wav";
	vol = 80;
};

instance SHEEP_Die(C_SFX_DEF)
{
	file = "SHP_Hurt_01.wav";
	vol = 80;
};

instance SHEEP_Die_A1(C_SFX_DEF)
{
	file = "SHP_Hurt_02.wav";
	vol = 80;
};

instance SHEEP_Die_A2(C_SFX_DEF)
{
	file = "SHP_Hurt_03.wav";
	vol = 80;
};

instance SHEEP_Die_A3(C_SFX_DEF)
{
	file = "SHP_Die_01.wav";
	vol = 80;
};
...
//  MAGPARADE
INSTANCE MFX_MAGPARADE(C_SFX_DEF) 
{
	file= "WSP_ATTACK_02.WAV";    
	vol = 127; 
};
...
// Quake
INSTANCE MFX_QUAKE_CAST(C_SFX_DEF) 
{
	file= "MFX_QUAKE_INVEST.WAV"; 
	vol = 90;  
};
INSTANCE MFX_QUAKE_STOMP(C_SFX_DEF) 
{
	file= "M_STEP_HUGE01.WAV";    
	vol = 127;      
	pitchOff=-50;   
};
INSTANCE MFX_QUAKE_EARTHQUAKE  (C_SFX_DEF) 
{
	file= "CS_PRAYER_MINECOLLIDE02.WAV";   
	vol = 110; 
};
...
// Explosion
INSTANCE MFX_EXPLOSION_COLLIDE (C_SFX_DEF) 
{
	file= "MFX_BARRIERE_SHOOT.WAV";        
	vol = 127;      
	pitchOff=-50; 
...
// pitch?
INSTANCE MFX_EXPLOSION_SPHERE  (C_SFX_DEF) 
{
	file= "CS_PRAYER_FOKUSFINAL.WAV";      
	vol = 127; 
}; // Max volume is 127
...
// Acid
INSTANCE MFX_ACID       (C_SFX_DEF) 
{
	file= "COOLBLADE.WAV"; 
	vol = 127; 
};
INSTANCE MFX_ACID_DOT   (C_SFX_DEF) 
{
	file= "PSILAB_LOOP.WAV";      
	vol = 110;      
	loop=1;    
};

// Extricate
INSTANCE MFX_EXTRICATE_COLLIDE (C_SFX_DEF) 
{
	file= "CS_IHL_ST_WO.WAV";     
	vol = 127; 
};
INSTANCE MFX_EXTRICATE_INHALE  (C_SFX_DEF) 
{
	file= "MFX_EXTRICATE_INHALE.WAV";      
	vol = 127; 
};


// Elevate
INSTANCE MFX_ELEVATE_BURST     (C_SFX_DEF) 
{
	file= "TREEDOWN.WAV";  
	vol = 127;      
	pitchOff=0; 
...
INSTANCE MFX_ELEVATE_STONES    (C_SFX_DEF) 
{
	file= "CS_PRAYER_MINECOLLIDE01.WAV";   
	vol = 127; 
};
INSTANCE MFX_ELEVATE_INVEST    (C_SFX_DEF) 
{
	file= "MFX_ELEVATE_INVEST.WAV";        
	vol = 127; 
};
INSTANCE MFX_ELEVATE_CAST      (C_SFX_DEF) 
{
	file= "WSP_WHOSH_01.WAV";     
	vol = 127;      
	pitchOff=-5; 
