// EWAGA Visnames für Firebolt green 
...
//EWAGA VISnames für Pyrokinesia == Pyrokinese blau
...
//*****************************************
//P I N K - G E Y S E R (by Dalay)
//*****************************************
INSTANCE MFX_GEYSER_PINK_INIT (C_PARTICLEFX)
{
     ppsvalue = 100;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE MFX_GEYSER_PINK_CAST (C_PARTICLEFX)
{
     ppsvalue = 100;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
     ...
     flygravity_s = "0 -0.0002 0";
     flycolldet_b = 3;
     visname_s = "Geyser_Pink_Drop.tga";
     visorientation_s = "VELO3D";
     vistexisquadpoly = 1;
     vistexanifps = 18;
     vistexcolorstart_s = "255 255 255";
...
INSTANCE MFX_GEYSER_PINK_FOUNTAIN (C_PARTICLEFX)
{
     ppsvalue = 10;
     ppsscalekeys_s = "1";
     ppsfps = 2;
...
INSTANCE MFX_GEYSER_PINK_PARTICLES (C_PARTICLEFX)
{
     ppsvalue = 1500;
     ppsscalekeys_s = "1";
     ppsfps = 2;
...
//*****************************************
//T U E R K I E S - G E Y S E R (by Dalay)
//*****************************************
INSTANCE MFX_GEYSER_TURK_INIT (C_PARTICLEFX)
{
     ppsvalue = 100;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE MFX_GEYSER_TURK_CAST (C_PARTICLEFX)
{
     ppsvalue = 100;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
     ...
     flygravity_s = "0 -0.0002 0";
     flycolldet_b = 3;
     visname_s = "Geyser_Turk_Drop.tga";
     visorientation_s = "VELO3D";
     vistexisquadpoly = 1;
     vistexanifps = 18;
     vistexcolorstart_s = "255 255 255";
...
INSTANCE MFX_GEYSER_TURK_FOUNTAIN (C_PARTICLEFX)
{
     ppsvalue = 10;
     ppsscalekeys_s = "1";
     ppsfps = 2;
...
INSTANCE MFX_GEYSER_TURK_PARTICLES (C_PARTICLEFX)
{
     ppsvalue = 1500;
     ppsscalekeys_s = "1";
     ppsfps = 2;
...
INSTANCE UNDEAD_DRAGON (C_PARTICLEFX)
{
     ...
     vistexcolorend_s = "155 50 150";  //Farbe nach Tabelle
     vissizestart_s = "10 10";
     vissizeendscale = 7;
     visalphafunc_s = "ADD";
     visalphastart = 255;
...
/* //////////////////////////////////////////////////////////////////////////////
    FARBENTABELLE Die Farben sind natürlich auch TGA abhängig. Aus einer dunkelgrünen TGA kann man kein purpurrot rausfiltern!!
    Man kann aber eine TGA setzen mit 10 versch. Farben zum Beispiel und dann Sterne instanzen in allen Farben über den Farbfilter rausholen.

    "255   0    0"; = Fettes Purpur 
    "150 150    0"; = Ganz blasses Gelb, eher weisslich
    "  0   0  255"; = Helles intensives leuchtendes Blau (etwa wie Magischer Bogen)
    "180   0    0"; = Zartes bläuliches Rosa/Lila (Heller Krapplack)
    
    
*/    
///////////////////////////////////////////////////  "Ich bezeichne das mal als Vorinstanz", die endgültige Instanz ist in der
// EWAGASTARS RED FÜR ORKJÄGERS ARMBRUST (by dalai)   VisualFXInst.d festgelegt. Die von mir erstellte Vorinstanz benötigt immer
///////////////////////////////////////////////////   noch eine Prototype Instanz. In diesem Falle die Item_Glimmer_Proto" hier in PFxInstMagic.d
INSTANCE ITEM_STARS_RED_01 (ITEM_GLIMMER_PROTO) 
{                                                  // Eigentlich genügt eine *.TGA die alle Farben enthält. Man kann dann über colorstart_s  die Farben regeln
	visname_s			= "Decal_Insane.tga";              // *.TGA wurde getauscht, da das original nicht rot genug war
	vistexcolorstart_s	= "255 0 0";                 // Farbwert beim Start Pur Pur Rot. Das geht natürlich nur, wenn die *.tga auch Rot enthält
	vistexcolorend_s	= "255 255 255";               // Farbwert am Ende des Loopes, immer auf die eingefügte TGA bezogen (Intensität)
	vissizeendscale		= 3;                           // Dieser Wert vergrössert die Sterne (Pixel)
};
///////////////////////////////////////////////////
// EWAGASTARS Yellow für Crossbow Trank (by dalai)
///////////////////////////////////////////////////
INSTANCE ITEM_STARS_YELLOW_01 (ITEM_GLIMMER_PROTO)
{
	visname_s			= "mfx_sleep_star.TGA";
	vistexcolorstart_s	= "150 150 0";      //  Regelt den Farbwert (das ist zum Beispiel "Zitrone/leicht grünlich")
	vistexcolorend_s	= "255 255 0";        //  Ende
	vissizeendscale		= 10; 
};
///////////////////////////////////////////////////
// EWAGASTARS Blue für Truhenöffn. Zauber (by dalai)
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
// EWAGASTARS Blue für Energy-Kristall (by dalai)
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
// EWAGASTARS Yellow für Energy-Kristall (by dalai)
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
// EWAGASTARS Red für Energy-Kristall (by dalai)
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
// EWAGASTARS Grün für Energy-Kristall (by dalai)
///////////////////////////////////////////////////
...
///////////////////////////////////////////////////
// EWAGAGLOW für HotHammer  (by dalai)
///////////////////////////////////////////////////
...
//	shpmesh_s			= "HUMANS.MDS";
	...
	vistexcolorend_s	= "255 255 0";
	vissizestart_s		= "2 2";
	vissizeendscale		= 100;   //10;  vergrössert
	visalphafunc_s		= "ADD";
	visalphastart		= 255;
	useemittersfor		= 0;
};
