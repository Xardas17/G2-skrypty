...
// Spiel PFX 
// ******************************************************************************************
INSTANCE TORCHMAGIC (C_PARTICLEFX)
{
     ...
     visname_s = "HUMANBURNBLUEMAGIC.TGA";  //"HUMANBURNMAGIC.TGA";
     visorientation_s = "VELO";
     vistexisquadpoly = 1;
     vistexanifps = 15.000000000;
     vistexaniislooping = 1;
...
INSTANCE THE_EYE_OF_BELIAR (C_PARTICLEFX)
{
     ppsvalue = 25;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE THE_EYE_OF_BELIAR_DIE (C_PARTICLEFX)
{
     ...
     lsppartavg = 1000.000000000;
     flygravity_s = "0";
     visname_s = "BEL_EYE_DIE01.TGA";
     visorientation_s = "VELO3D";
     vistexisquadpoly = 1;
     vistexanifps = 10.000000000;
     vistexaniislooping = 1;
     vistexcolorstart_s = "255 69 0"; //  "255 255 255"
     vistexcolorend_s = "255 69 0";   //  "255 255 255"
     vissizestart_s = "10 100";
     vissizeendscale = 1.000000000;
     visalphafunc_s = "ADD";
     visalphastart = 255.000000000;
     trltexture_s = "BEL_EYE_DIE02.TGA";
};

INSTANCE THE_EYE_OF_BELIAR_WARN (C_PARTICLEFX)
{
     ppsvalue = 400.;
     ...
     lsppartvar = 100;
     flygravity_s = "0 0 0";
     visname_s = "LIGHTNING_BIG_A0.TGA"; // "REDGLOW.TGA";
...
INSTANCE FIRE_HOT_BLUE (C_PARTICLEFX)
{
...
// Ewaga Giftgas
// /////////////////////////////////////////////////////////////////////////////
instance EWAGA_GIFTGAS (C_PARTICLEFX)
{
...
// /////////////////////////////////////////////////////////////////////////////
// EWAGA THE GREEN EYE       (by dalai)
// /////////////////////////////////////////////////////////////////////////////
  INSTANCE THEGREENEYE (C_PARTICLEFX)
{
     ppsvalue = 25;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
     ...
     lsppartavg = 1000;
     flygravity_s = "0 0 0";
     visname_s = "ITEM_STARS_GREEN_01"; //"mfx_masterofdisaster_aura_16bit.tga";
     visorientation_s = "VELO";
     vistexisquadpoly = 1;
     vistexanifps = 18;
     vistexaniislooping = 1;
...
// /////////////////////////////////////////////////////////////////////////////
// EWAGA Mini Feuer      (by dalai)
// /////////////////////////////////////////////////////////////////////////////
INSTANCE FIRE_MINI (C_PARTICLEFX)
{
...
/*
 {
	...
	emtrjdynupdatedelay		= 20;
	emfxlifespan			= -1;
	emselfrotvel_s			= "0 0 0";
	secsperdamage			= -1;
	emAdjustShpToOrigin		= 1;
  lightpresetname			= "GREENAMBIENCE"; 	
};
*/


INSTANCE PFX_FACKEL_FAKE (C_PARTICLEFX)
{
     ppsvalue = 1;
     ppsscalekeys_s = "1";
     ppsissmooth = 0;
     ...
     shpisvolume = 1;
     shpdim_s = "200";
     shpmesh_s = "ItLs_Torch_01.3DS";
     shpmeshrender_b = 1;//Sollte die 3DS rendern lassen
     shpscalekeys_s = "1";
     shpscaleislooping = 0;
     shpscaleissmooth = 1;
     shpscalefps = 1;
...
/*
instance FX_Fackel_Fake(CFx_Base_Proto)
{
		visname_S 		= "PFX_FACKEL_FAKE";// - PFX-Name
		emtrjmode_s 		= "FIXED"; //Damit der FX heften bleibt
		emTrjOriginNode 	= "BIP01 L Hand"; //OriginNode - Ursprung
...
INSTANCE TEMPELFLIEGE_EXPLODE (C_PARTICLEFX)
{
     ppsvalue = 80;
     ppsscalekeys_s = "1";
     ppsissmooth = 1;
...
INSTANCE TEMPELFLIEGE_ATTACK (C_PARTICLEFX)
{
     ppsvalue = 200;
     ppsscalekeys_s = "1";
     ppsfps = 2;
...
INSTANCE COALGLOW (C_PARTICLEFX)  // glühende Kohle
{
...
// ****************************************************************
// Waschen im Tümpel mit Hundefäkalien oder einreiben mit Hundeurin
// ****************************************************************
INSTANCE HUMAN_WASHSELF1_GELB (C_PARTICLEFX)
{
     ppsvalue = 600.000000000;
     ppsscalekeys_s = "1";
     ppsissmooth = 1;
     ...
     lsppartvar = 200.000000000;
     flygravity_s = "0 -0.0005 0";
     visname_s = "WASHSELF2_GELB.TGA";
     visorientation_s = "VELO";
     vistexisquadpoly = 1;
     vistexanifps = 15.000000000;
     vistexaniislooping = 1;
     vistexcolorstart_s = "255 165 0";
     vistexcolorend_s = "100 200 255";
     vissizestart_s = "2 2";
     vissizeendscale = 10.000000000;
     visalphafunc_s = "BLENND";
...
INSTANCE HUMAN_WASHSELF2_GELB (C_PARTICLEFX)
{
     ppsvalue = 2000.000000000;
     ppsscalekeys_s = "1";
     ppsissmooth = 1;
...
INSTANCE URINWATER (C_PARTICLEFX)
{
     ppsvalue = 15.;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE BUBBLES (C_PARTICLEFX)
{
     ...
     lsppartvar = 100;
     flygravity_s = "0 0.00001 0";
     visname_s = "WASSERRINGE_A0.tga"; // "BUBBLE.TGA";
     visorientation_s = "VELO";
     vistexisquadpoly = 1;
     vistexanifps = 15;
     vistexaniislooping = 1;
...
// Saftpresse Saft aus dem Rohr beim Pressen
