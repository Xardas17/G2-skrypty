...
instance RIS_DAY_STD(C_MUSICTHEME_STANDARD)
{
	file = "04.OGG";
};

instance RIS_DAY_FGT(C_MUSICTHEME_FIGHT)
{
	file = "03.OGG";
};

instance RI1_DAY_STD(C_MUSICTHEME_STANDARD)
{
	file = "BT_AMBIENT1.WAV";
};

instance RI1_DAY_FGT(C_MUSICTHEME_FIGHT)
{
	file = "BT_AMBIENT1.WAV";
};
